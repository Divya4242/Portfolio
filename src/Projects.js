    ...
    return (
        <div className="projects">
            ...
            <div style={{ marginTop: "30px" }} className="certifications">
                ...
                <hr style={{ width: "70%", position: "relative", left: "15%" }}></hr> <br />
                <div className="img">
                    <a id="AWS" onmouseover="cursor:'pointer'" target="_blank" rel="noreferrer" href="https://www.credly.com/badges/0d8a3cd4-65d5-4536-8484-e6207729daf9/public_url"><img id="myAWS" alt="AWS Solution Architect" title="AWS Solution Architect Associate Certification" style={{ width: "190px", height: "190px", backgroundColor: "aliceblue" }} src={AWS}></img></a>
                    <a id="AZ" onmouseover="cursor:'pointer'" target="_blank" rel="noreferrer" href="https://www.credly.com/badges/e68b5950-30db-4e34-ba71-b3928f39a408/public_url"><img id="myAZ" alt="Azure Fundamental Cetificate AZ-900" title="Azure Fundamental Certification" style={{ cursor: "pointer",marginLeft: "10px" }} src={Az}></img></a>
                    <a id="Google" onmouseover="cursor:'pointer'" target="_blank" rel="noreferrer" href="https://www.credential.net/3f3764a4-151c-484f-9626-41f076d4799f#gs.10045np"><img id="myGoogle" style={{ marginLeft: "10px", cursor: "pointer" }} alt="Google Cloud Digital Leader" title="Google Cloud Digital Leader Certification" src="https://api.accredible.com/v1/frontend/credential_website_embed_image/badge/70951264?key=fd1b640dade2417f43ccfa1848122130055c397245e58883f2bbce165356002b"></img></a>
                </div>
            </div>
        </div>
